        ...
        <div className="w-[77%] h-full">
          ...
          <div className="mt-6 px-10">
            <div className="grid grid-cols-4">
              <div className="bg-white p-4 border shadow-md flex flex-col space-y-4 mr-7">
              ...
              <div className="bg-white p-4 border shadow-md flex flex-col space-y-4 mr-7">
                <p className="text-sm">Max. Needs Budget</p>
              ...
              <div className="bg-white p-4 border shadow-md flex flex-col space-y-4 mr-7">
                <p className="text-sm">Max. Wants Budget</p>

                <p className="font-bold text-2xl">₦0</p>

                <div className="flex justify-between">
                  <p className="text-primary font-semibold">30%</p>
                  <span className="p-2 rounded-md bg-purple-300">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
              ...
              <div className="bg-white p-4 border shadow-md flex flex-col space-y-4 ">
                <p className="text-sm">Max. Savings Budget</p>

                <p className="font-bold text-2xl">₦0</p>

                <div className="flex justify-between">
                  <p className="text-primary font-semibold">20%</p>
                  <span className="p-2 rounded-md bg-purple-400">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
