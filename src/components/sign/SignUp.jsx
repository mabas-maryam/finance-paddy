    ...
    <div className='container mx-auto px-10'>
      <div className='flex px-10 shadow-md'>
        <div className='w-1/2 h-full flex items-center flex-col justify-center  py-16 border-r'>
          <Link to={'/'} className='justify-center items-center font-primaryFont text-2xl font-semibold'>Finance <span className='text-primary '>Paddy</span></Link>
        ...
        <div className='w-1/2 py-12 h-screen px-16'>
          <div className=''>
            ...
            <p className='font-bold font-tertiaryFont text-2xl'>Sign In to Finance-Paddy</p>
          </div>
            ...
            <div className="bg-white rounded w-full">
              ...
              <form className="space-y-4 w-full">
                ...
                <div className='relative'>
                  ...
                  <span className="absolute text-gray-500 right-4 top-10"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.242L9.88 9.88" />
                  </svg></span>
